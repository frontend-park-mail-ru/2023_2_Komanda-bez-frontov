...
templates['navbar'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<nav class=\"navbar\">\n    <div class=\"navbar_logo\" id=\"navbar-logo\">\n        <img src=\"../../resources/images/icon.jpg\" alt=\"\">\n        <span class=\"material-symbols-outlined\">description</span>\n        <a id=\"navbar-logo-label\">\n            FormHub\n        </a>\n    </div>\n    <div class=\"navbar_profile\" id=\"navbar-profile\">\n"
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"user") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data,"loc":{"start":{"line":10,"column":4},"end":{"line":18,"column":11}}})) != null ? stack1 : "")
    + "    </div>\n</nav>\n";
},"useData":true});
})();