...
templates['results_question'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
  ...
  return "    <div class=\"results-question\">\n        <div class=\"results-question_title-container\">\n            <h3 class=\"results-question__description-title\">"
    ...
    + "        </div>\n"
    + ((stack1 = (lookupProperty(helpers,"ifEquals")||(depth0 && lookupProperty(depth0,"ifEquals"))||alias4).call(alias3,((stack1 = (depth0 != null ? lookupProperty(depth0,"question") : depth0)) != null ? lookupProperty(stack1,"type") : stack1),2,{"name":"ifEquals","hash":{},"fn":container.program(9, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":22,"column":8},"end":{"line":24,"column":21}}})) != null ? stack1 : "")
    + "    </div>\n";
  ...
  return "                    <div class=\"results-question_answers_answer-item\">\n                        <p class=\"results-question_answers_answer-item__answer-text\">"
    ...
    return "            <p class=\"results-question__answers-title\">Проценты считаются от общего количества ответов</p>\n";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"question") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":26,"column":7}}})) != null ? stack1 : "");
