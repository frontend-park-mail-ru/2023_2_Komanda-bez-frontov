...
templates['update_question'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "                <div class=\"update-question__answer-format\">\n                    <input id=\"update-question__answer-format_text\" type=\"radio\">\n                    <label for=\"update-question__answer-format_text\">Текст</label>\n                    <input id=\"update-question__answer-format_radio\" type=\"radio\">\n                    <label for=\"update-question__answer-format_radio\">Один вариант</label>\n                    <input id=\"update-question__answer-format_checkbox\" type=\"radio\" checked>\n                    <label for=\"update-question__answer-format_checkbox\">Несколько вариантов</label>\n                </div>\n                <div class=\"update-question__answers\">\n                    <h3 class=\"update-question__answers-title\">Ответы</h3>\n"
  ...
  return "                        <div class=\"update-question__answers-item\">\n                            <input class=\"update-question__answers-item-radio\" id=\"update-question__answers-item-radio\" type=\"radio\"></input>\n                            <input class=\"update-question__answers-item-input\" type=\"text\" value=\""
    ...
    return "                <div class=\"update-question__answer-format\">\n                    <input id=\"update-question__answer-format_text\" type=\"radio\" checked>\n                    <label for=\"update-question__answer-format_text\">Текст</label>\n                    <input id=\"update-question__answer-format_radio\" type=\"radio\">\n                    <label for=\"update-question__answer-format_radio\">Один вариант</label>\n                    <input id=\"update-question__answer-format_checkbox\" type=\"radio\">\n                    <label for=\"update-question__answer-format_checkbox\">Несколько вариантов</label>\n                </div>\n";
