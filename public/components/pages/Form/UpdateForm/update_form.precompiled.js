...
templates['update_form'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"update-form\">\n        <div class=\"update-form__description\">\n            <p class=\"check-question__required-title display-none\" id=\"update-form-title-validation-error\">Текст должен состоять из русских или английских слов, цифр и знаков препинания</p>\n            <div class=\"update-form__description-header\">\n                <input class=\"update-form__title-input\" id=\"update-form__title\" placeholder=\"Введите название опроса\" value=\""
    ...
    + "                <label class=\"update-form_anonymous__checkbox-label\" for=\"update-form-anonymous-checkbox\">Анонимный опрос</label>\n            </div>\n            <div class=\"update-form__anonymous-warning-container\">\n                <span class=\"check-form__anonymous-warning-icon\">⚠️</span>\n                <p class=\"check-form__anonymous-warning\">Включив анонимный опрос вы не сможете получать информацию о участниках опроса</p>\n            </div>\n            <div class=\"update-form__max-passage-container\">\n                <label>Лимит прохождений: </label>\n                <input class=\"update-form_max-passage__input\" id=\"update-form__max-passage\"\n                       type=\"number\" min=\"0\" placeholder=\"Без ограничений\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? lookupProperty(depth0,"form") : depth0)) != null ? lookupProperty(stack1,"passage_max") : stack1), depth0))
    + "\">\n            </div>\n            <div class=\"update-form__max-passage-container\">\n                <label>Дата архивации: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>\n                <input class=\"update-form_max-passage__input\" id=\"update-form-archive-time\"\n                       type=\"date\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? lookupProperty(depth0,"form") : depth0)) != null ? lookupProperty(stack1,"archive_when") : stack1), depth0))
    + "\">\n                <p class=\"check-form__anonymous-warning\">Вы можете задать дату, когда опрос автоматически перейдет в архив.\n                    Оставьте поле пустым, чтобы опрос оставался активным</p>\n            </div>\n        </div>\n        <div class=\"update-form__questions-container\" id=\"check-form__questions-container\"></div>\n        <button class=\"update-form_add-question-button\" type=\"submit\" id=\"add-button\">+</button>\n\n        <div class=\"button-container\">\n            <button class=\"secondary-button\" type=\"submit\" id=\"update-button\">Cохранить</button>\n        </div>\n    </div>\n";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"form") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":42,"column":7}}})) != null ? stack1 : "");
},"useData":true});
})();